...
**(a)** You operate the Software for that customer’s own use, such as their website, application, intranet, extranet, digital service, or internal business purpose, and not as a shared, general-purpose product that gives third parties access to the Software itself;

**(b)** the customer holds any commercial license, subscription, license key, or other entitlement that the Software requires, issued or approved by Licensor; and

**(c)** You provide the Software as part of Your broader consulting, development, or infrastructure services, rather than offering the Software as a standalone, generalized cloud service.
