...
By using, copying, modifying, distributing, making available, or preparing derivative works of the Software, You agree to this License.

## 1. Definitions

* "Licensee" or "You" means the individual or legal entity exercising the permissions granted by this License.
* "Licensor" means Enonic AS.
* "Software" means the software, source code, object code, and associated documentation governed by this License.

## 2. Grant of License

**(a)** Copyright Grant: Subject to the terms and limitations of this License, Licensor grants You a worldwide, royalty-free, non-exclusive, non-sublicensable, and non-transferable license to use, copy, distribute, make available, modify, and prepare derivative works of the Software.

**(b)** Patent Grant: Subject to the terms and limitations of this License, Licensor grants You a worldwide, royalty-free, non-exclusive, non-sublicensable, and non-transferable license under any patent claims Licensor can license that are necessarily infringed by Your use of the Software as provided by Licensor. This patent license does not extend to any patent claims that would be infringed only as a result of modifications or additions You make to the Software.
...
## 3. Limitations and Permitted Hosting

**(a)** General Limitation: You may not provide the Software, or substantially similar functionality based on the Software, to third parties as a hosted, managed, cloud, SaaS, PaaS, white-label, or service-provider offering where the Software itself forms a substantial part of the service being offered. This limitation applies whether the service is single-tenant or multi-tenant, self-service or manually provisioned, modified or unmodified.
...
## 4. Premium Features and Anti-Circumvention
...
You may not bypass, disable, remove, alter, or circumvent such measures, or modify the Software for the purpose of accessing restricted functionality without a valid entitlement issued or approved by Licensor.
...
## 5. Notices and Third-Party Components
...
If You violate this License, the permissions granted to You terminate automatically. However, Your rights are reinstated if You fix the violation within 30 days of being notified by Licensor.
